...
Se na posição 06 (Tipo de Registro) do Líder é utilizado o código **m** (arquivo de Computador) então devem ser utilizados os seguintes códigos:
...
**18-21 Indefinido;** contém branco(#) ou caracter cheio (\|)
...
**branco** Desconhecida ou não especificada
...
**24****-25** **Indefinido;** contém branco(#) ou caracter cheio (\|)

**26 Tipo do arquivo de computador**

Indica o tipo de arquivo de computador do item processado
...
**27 Indefinido;** contém branco(#) ou caracter cheio (\|)
...
**29-34 Indefinido;** contém branco(#) ou caracter cheio (\|)
